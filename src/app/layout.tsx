...
export const metadata: Metadata = {
  ...
  title: {
    default: "Solvin | Useful software for real work",
    template: "%s | Solvin",
  },
  description:
  ...
  openGraph: {
    ...
    images: [{ url: "/solvin-social.svg", width: 1200, height: 630, alt: "Solvin — Useful software for real work." }],
  },
  twitter: { card: "summary_large_image", title: "Solvin | Useful software for real work", description: "From the way work happens to the software that improves it.", images: ["/solvin-social.svg"] },
};
